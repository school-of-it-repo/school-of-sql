...
-- schoolofit.hr_employee definition

-- Drop table

-- DROP TABLE schoolofit.hr_employee;

CREATE TABLE schoolofit.hr_employee (
...
INSERT INTO schoolofit.hr_employee (employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id) VALUES
